(function ($) {
  ...
  // init manual banner parallax content scroll effect
  var initBannerParallax = function () {
    var $banner = $('#billboard');
    var $content = $('#billboard .banner-content');
    ...
    $(window).on('scroll', function () {
      ...
      if (scrollTop + $(window).height() > offset && scrollTop < offset + height) {
        var y = (scrollTop - offset) * 0.35;
        $content.css('transform', 'translate3d(0,' + y + 'px,0)');
      }
    });
  }
